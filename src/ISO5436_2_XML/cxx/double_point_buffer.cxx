...
OGPS_Boolean DoublePointBuffer::Allocate(const unsigned long size)
{
   if(!m_Buffer)
   {
      m_Buffer = (double*)PointBuffer::Allocate(size, sizeof(double));
...
OGPS_Boolean DoublePointBuffer::Set(const unsigned long index, const double value)
{
...
OGPS_Boolean DoublePointBuffer::Get(const unsigned long index, double& value) const
{
   _ASSERT(index < GetSize() && m_Buffer);
...
OGPS_Boolean DoublePointBuffer::SetNull(const unsigned long index)
{
   double n = 0.0;
   return Set(index, n);
}
