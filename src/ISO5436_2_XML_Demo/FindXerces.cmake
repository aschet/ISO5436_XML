...
ELSE(DEFINED MSC_VERSION)
  SET(XERCES_LIB_PATH_POSTFIX "")
  SET(XERCES_LIB_POSTFIX "")
ENDIF (DEFINED MSC_VERSION)
...
ELSE (XERCESC_STATIC)
  ...
  FIND_LIBRARY(XERCESC_LIBRARY_DEBUG NAMES xerces-c_3D xerces-c_3_1_vc100D xerces-c_3_1${XERCES_LIB_POSTFIX} xerces-c-3.1${XERCES_LIB_POSTFIX} libxerces-c-3.1.dylib libxerces-c.dylib
   PATHS
   $ENV{XERCESC_LIBRARY_DIR}
   ${XERCESC_LIBRARY_DIR}
  "$ENV{ProgramFiles}/CodeSynthesis XSD 3.3/${XERCES_LIBPATH_POSTFIX}"
